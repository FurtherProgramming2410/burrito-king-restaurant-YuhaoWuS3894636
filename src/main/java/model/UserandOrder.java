...
public class UserandOrder {
    ...
    public UserandOrder(String username, String password, String firstName, String lastName) {
    ...
    public UserandOrder(Double burritonumber, Double friesnumber, Double sodanumber, Double mealnumber) {
        this.burritonumber = burritonumber;
        this.friesnumber = friesnumber;
        this.sodanumber = sodanumber;
        this.mealnumber = mealnumber;
    }
    public UserandOrder(Double waitingtime, Double totalprice, Double burritonumber, Double friesnumber, Double sodanumber, Double mealnumber) {
        this.burritonumber = burritonumber;
        this.friesnumber = friesnumber;
        this.sodanumber = sodanumber;
        this.mealnumber = mealnumber;
    ...
    public UserandOrder(Double waitingtime, Double totalprice){
        this.waitingtime = waitingtime;
        this.totalprice = totalprice;
    }
